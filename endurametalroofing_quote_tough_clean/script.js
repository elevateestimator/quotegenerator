...
function buildPrintClone() {
  ...
  style.textContent = `
    ...
    .pdf-letterhead .pdf-top { display:flex; align-items:flex-end; justify-content:space-between; gap:12px; }
    .pdf-letterhead .pdf-company {
      font: 900 20px/1.15 Inter, ui-sans-serif, system-ui;
      color: var(--steel, #0b0f14);
      letter-spacing: .2px;
    }
    .pdf-letterhead .pdf-doc-type {
      font: 900 11px/1 Inter, ui-sans-serif, system-ui;
      letter-spacing: .18em;
      text-transform: uppercase;
      color: var(--steel, #0b0f14);
      padding: 6px 10px;
      border-radius: 999px;
      border: 1px solid rgba(2,103,181,.55);
      background: #f3f4f6;
      white-space: nowrap;
    }
    ...
    .pdf-letterhead + .pdf-accent { height:4px; background: linear-gradient(90deg, #0267b5, rgba(2,103,181,.35)); border-radius: 3px; margin: 10px 0 8px; }
